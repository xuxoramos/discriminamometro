...
class capa1():
    ...
    def __init__(self):
        ...
        self.str_ruta_entrenamiento = '00_entrenamiento/tweets_modelo_capa1'
        self.str_fuente_clasificacion = 'tweets_entrenamiento_capa1.csv'
        self.str_LocalFile = 'data/tweets/' + self.str_fuente_clasificacion
        self.str_nombrePickle = 'modelo_capa1.p'
        self.str_ruta_s3_modelos = '01_modelos/capa1'
        ...
        dictHyperParams = {'learning_rate': [0.1,0.25],
                           'n_estimators': [50,100],  # Se redujo a 50
                           'min_samples_split': [4,16],
                           'min_samples_leaf': [3,7],
                           'max_depth': [3,4,5],
                           'max_features': ['sqrt']
