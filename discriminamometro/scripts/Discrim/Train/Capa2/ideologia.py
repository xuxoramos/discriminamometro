...
class Ideologia(base_train.BaseTrain):
    ...
    def __init__(self):
        ...
        self.str_fuente_clasificacion = 'tweets_entrenamiento_ideologia_balance.csv'
        self.str_LocalFile = 'data/tweets/' + self.str_fuente_clasificacion
        self.str_nombrePickle = 'modelo_capa2_ideologia_prueba.p'
