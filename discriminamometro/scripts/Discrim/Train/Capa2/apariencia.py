...
class Apariencia(base_train.BaseTrain):
    ...
    def __init__(self):
        ...
        self.str_fuente_clasificacion = 'tweets_entrenamiento_apariencia_balance.csv'
        self.str_LocalFile = 'data/tweets/' + self.str_fuente_clasificacion
        self.str_nombrePickle = 'modelo_capa2_apariencia_prueba.p'
