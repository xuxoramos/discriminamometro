...
class Religion(base_train.BaseTrain):
    ...
    def __init__(self):
        ...
        self.str_fuente_clasificacion = 'tweets_entrenamiento_religion_balance.csv'
        self.str_LocalFile = 'data/tweets/' + self.str_fuente_clasificacion
        self.str_nombrePickle = 'modelo_capa2_religion_prueba.p'
        self.str_ruta_s3_modelos = '01_modelos/capa2/religion'
