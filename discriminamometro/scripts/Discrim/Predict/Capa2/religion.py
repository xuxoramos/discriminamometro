...
class Religion(base_modelos.BasePredict):
    ...
    def __init__(self):
        ...
        self.str_ruta_modelo_s3 = '01_modelos/capa2/religion/modelo_capa2_religion.p'
        self.str_archivo_modelo_local = 'modelo_capa2_religion.p'
